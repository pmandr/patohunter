...
public class Ave3 extends Ave {
    Image asaFechadaDir = (new ImageIcon("src/cacador/images/ave311.png")).getImage();
    Image asaFechadaEsq = (new ImageIcon("src/cacador/images/ave312.png")).getImage();
    Image asaAbertaDir  = (new ImageIcon("src/cacador/images/ave321.png")).getImage();
    Image asaAbertaEsq  = (new ImageIcon("src/cacador/images/ave322.png")).getImage();
    Image morrendo = (new ImageIcon("src/cacador/images/ave330.png")).getImage();
